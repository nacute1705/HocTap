...
--
-- Host: 127.0.0.1
-- Generation Time: May 25, 2022 at 01:51 PM
...
(1, 1, 29, 'Denim Ripped Flares', 700000, 1),
(2, 1, 14, 'Secret Garden Corset Mini Dress', 700000, 1),
(3, 1, 21, 'Check Pattern Tie Front Crop Top', 450000, 1),
(4, 2, 17, 'Floral Bell Sleeve Corset Mini Dress', 800000, 1),
(5, 2, 5, 'Heart Knit Hat', 400000, 2);
...
INSERT INTO `donhang` (`Id`, `TenKH`, `Sdt`, `Email`, `Diachigiaohang`) VALUES
(1, 'Lê Thuỳ Na', 362417182, 'nalethuy@gmail.com', 'Tân Bình'),
(2, 'Trần Trọng Bình Phương', 123456789, 'phuongtran26122000@gmail.com', 'Tân Phú');
