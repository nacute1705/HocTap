...
public class GiohangAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view==null)
        {
            ...
            view = inflater.inflate(R.layout.dong_giohang,null); // err
        ...
        if(sl>=10)
        {
            viewHolder.btnplus.setVisibility(View.INVISIBLE);//ẩn nút cộng
            viewHolder.btnminus.setVisibility(View.VISIBLE);//hiện nút trừ

        } else if(sl<=1)
        {
            viewHolder.btnminus.setVisibility(View.INVISIBLE);//ẩn nút trừ
        }
        else
        {
            viewHolder.btnplus.setVisibility(View.VISIBLE);//ẩn nút cộng
            viewHolder.btnminus.setVisibility(View.VISIBLE);//hiện nút trừ
        }
        ...
        viewHolder.btnplus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                com.example.shopquanao.activity.Giohang.EvenUltil();
                if(slmoinhat>9)//kích lần thứ 9 thì sp sẽ là 10
                {
        ...
        viewHolder.btnminus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                finalViewHolder.txtgiagiohang.setText(decimalFormat.format(giamoinhat) +"Đ");
                com.example.shopquanao.activity.Giohang.EvenUltil();
                if(slmoinhat <2)//kích lần thứ 9 thì sp sẽ là 10
                {
